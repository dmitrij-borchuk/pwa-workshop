...
const FAIL_ON_ERROR = process.env.FAIL_ON_ERROR ?
  JSON.parse(process.env.FAIL_ON_ERROR) : !MODE_DEV_SERVER;
...
plugins.push(new HtmlWebpackPlugin({
  ...
  // inject scripts in dev-server mode - in build mode, use the template tags
  inject: MODE_DEV_SERVER,
  MODE_DEV_SERVER,
  DEVTOOLS,
  BANNER_HTML
}));
